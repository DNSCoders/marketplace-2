...
<footer>
    ...
    <div class="about-for-mobile">
        ...
        <img src="<?= base_url(); ?>assets/images/logo/<?= $settingss['logo']; ?>" alt="logo" width="100">
        <p>
            <?= $setting['short_desc']; ?>
        </p>
        <div class="sosmed">
    ...
    <div class="copyright">
        <p class="mb-0">Copyright &copy;<span id="footer-cr-years"></span> <?= $this->Settings_model->general()["app_name"]; ?> by DNSCode.</p>
    </div>
</footer>
